...
def BMI():
    ...
    if bmi<=18.5:
        ...
        label3.config(text="It indicates that a person is \n slightly overweight! \n A doctor may advise to lose some \n weight for helath reasons!")
        
    else:
        label2.config(text="Obese!")
        label3.config(text="Health maybe at risk ,if they do not \n lose weight!")
        
    

# title icon
image_icon=PhotoImage(file="C:\MAHEND\icon.png")
root.iconphoto(False,image_icon)

#top 
top=PhotoImage(file= "C:\MAHEND/top.png")
...
#two boxes
box= PhotoImage(file="C:\MAHEND/box.png")
Label(root,image=box).place(x=20,y=100)
Label(root,image=box).place(x=240,y=100)

#scale
scale=PhotoImage(file="C:\MAHEND\scale.png")
...
def slider_changed(event):
    ...
    img= (Image.open("C:\MAHEND\man.png"))
